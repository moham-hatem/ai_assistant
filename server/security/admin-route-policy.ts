...
const protectedRoutes: readonly ProtectedRoute[] = [
  ...
  route('GET', /^\/api\/internal\/system-diagnostics$/u, 'settings:manage'),
  route('GET', /^\/api\/internal\/backups$/u, 'settings:manage'),
  route('POST', /^\/api\/internal\/backups$/u, 'settings:manage'),
  route('GET', /^\/api\/internal\/backups\/[^/]+\/download$/u, 'settings:manage'),
  route('POST', /^\/api\/internal\/backups\/[^/]+\/validate$/u, 'settings:manage'),
