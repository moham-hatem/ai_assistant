...
const protectedRoutes = [
  ...
  ['GET', '/api/internal/system-diagnostics', 'settings:manage'],
  ['GET', '/api/internal/backups', 'settings:manage'],
  ['POST', '/api/internal/backups', 'settings:manage'],
  ['GET', '/api/internal/backups/backup-id/download', 'settings:manage'],
  ['POST', '/api/internal/backups/backup-id/validate', 'settings:manage'],
...
test('admin route policy rejects unknown and method-mismatched admin operations', () => {
  const denied = [
    ...
    ['POST', '/api/internal/system-diagnostics'],
    ['DELETE', '/api/internal/backups/backup-id'],
    ['POST', '/api/internal/backups/backup-id/restore'],
