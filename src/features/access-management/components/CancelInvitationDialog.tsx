...
export function CancelInvitationDialog(props: CancelInvitationDialogProps) {
  return (
    <AccessDialog closeLabel={props.copy.actions.close} descriptionId="cancel-invitation-description" dismissible={!props.busy} onClose={props.onClose} title={props.copy.activeInvitations.cancelTitle}>
      ...
      <div aria-busy={props.busy} className="access-dialog-actions">
        <button autoFocus className="access-secondary" disabled={props.busy} onClick={props.onClose} type="button">{props.copy.actions.cancel}</button>
