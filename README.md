...
تبويب `#knowledge` يرفع الملفات إلى API محلي. تُحفظ النسخة الأصلية داخل `data/documents`، ويُحفظ النص المستخرج داخل `data/knowledge/imported` للبحث. المجلدان مستبعدان من Git افتراضيًا لحماية المحتوى وتقليل حجم المستودع.
