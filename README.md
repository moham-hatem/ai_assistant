...
يوفّر المشروع PWA جزئية قابلة للتثبيت وتحتفظ فقط بواجهة التطبيق الآمنة وأصولها الثابتة. فتح الواجهة دون اتصال قد ينجح بعد زيارتها مرة، لكن إرسال الأسئلة وتوليد الإجابات يحتاجان دائمًا اتصالًا وخدمة API عاملة؛ لا تُخزّن أسئلة المستخدم أو إجاباته أو بيانات الكتب في cache المتصفح.
