...
يوفّر المشروع PWA جزئية قابلة للتثبيت وتحتفظ فقط بواجهة التطبيق الآمنة وأصولها الثابتة. تعرض الواجهة حالة انقطاع الاتصال في تطبيق المتعلم ولوحة الإدارة، وتمنع إرسال سؤال جديد مع إبقاء مسودته، كما تطلب موافقة المستخدم قبل تطبيق تحديث جاهز. فتح الواجهة دون اتصال قد ينجح بعد زيارتها مرة، لكن البحث وإرسال الأسئلة وتوليد الإجابات وعمليات الإدارة تحتاج اتصالًا وخدمة API عاملة؛ لا تُخزّن أسئلة المستخدم أو إجاباته أو بيانات الكتب في cache المتصفح. ما زال يلزم توافق نسخ الواجهة وAPI واختبار تثبيت وتحديث حقيقي عبر HTTPS أو production preview قبل اعتبار المرحلة مكتملة.
