...
مصادقة الفريق والتفويض الخادميان شرطان قبل نشر أي سطح إداري. أما Telegram وPWA للمتعلم فقد يبقيان بلا تسجيل دخول حسب قرار المنتج؛ تتطلب إتاحتهما العامة عدم تعريض صفحات الإدارة أو admin APIs، مع حماية مستقلة للواجهات العامة تشمل rate limits ومكافحة إساءة الاستخدام وسياسة بيانات. لا يمنع ذلك تطوير الـPWA واختباره محليًا في الوضع الموثوق. التفاصيل والأدوار ومتطلبات الجلسات والتدقيق موثقة في [نطاق المنتج](docs/PRODUCT_SCOPE.md) و[خارطة الطريق](docs/ROADMAP.md).
